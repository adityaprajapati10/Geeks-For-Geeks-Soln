...
class Solution {
    public String getSubTree(Node root , List<Node> list , HashMap<String , Integer> map){
        if(root == null){
            return "N";
        }
        StringBuilder s = new StringBuilder();
        s.append(root.data).append(",")
        .append(getSubTree(root.left , list , map)).append(",")
        .append(getSubTree(root.right , list , map));
